...
//  konstruktor
    ...
    get room(){
     ...
     addChat(mess) {  //pravimo asinhroni metod, primace poruku kao parametar
        ...
        let response = await this.chats.add(chat);  //kada u this.chats dodamo kreirani chat - to je odgovor koji ceka (awaits)
